...
**Parallelizing approxposterior**

The above optimizations do not have to occur sequentially, but can be done in
parallel using multiprocessing.  The nCores keyword argument controls how many
cores are used to distribute this optimization, with the default being 1.  To use
all available cores, set nCores = -1.
